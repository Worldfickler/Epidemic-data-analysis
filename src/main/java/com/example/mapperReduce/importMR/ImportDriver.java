...
import com.example.mapperReduce.suspectedMR.SuspectedDriver;
import com.example.mapperReduce.suspectedMR.SuspectedMapper;
import com.example.mapperReduce.suspectedMR.SuspectedReducer;
import com.example.mapperReduce.suspectedMR.SuspectedWritable;
...
public class ImportDriver {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        FileOutputFormat.setOutputPath(job, new Path("data/city_import_output"));

        FileSystem fs = FileSystem.get(configuration);
        if(fs.exists(new Path("data/city_epidemic.txt"))){
            fs.delete(new Path("data/city_import_output"),true);
        }
